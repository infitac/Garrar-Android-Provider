package com.garrar.driver.app.common;
...
public class AppConstant {
    ...
    public static final String userAppPackageName = "com.mobiz.pilot";
    public static final String DEFAULT_COUNTRY_DIAL_CODE = "+90";
    public static final String DEFAULT_COUNTRY_CODE = "TU";
