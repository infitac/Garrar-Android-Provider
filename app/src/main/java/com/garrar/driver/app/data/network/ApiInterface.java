package com.garrar.driver.app.data.network;

import com.garrar.driver.app.data.network.model.AddressResponse;
...
public interface ApiInterface {
    ...
    @FormUrlEncoded
    @POST("api/user/get_curier_information")
    Observable<CourierDetail> getCourierDetail(@FieldMap HashMap<String, Object> params);
...
//    Observable<Object> sendFcm(@Body JsonObject jsonObject);
    ...
    @POST("api/user/get_all_courier_packages")
    Observable<PackageType> getPackageType();
    ...
    Observable<TripResponse> requestInstantRide(@PartMap() Map<String, RequestBody> partMap,@Part MultipartBody.Part filename);
    ...
    @FormUrlEncoded
    @POST("api/user/estimated/fare_without_auth_new")
    Observable<EstimateFareNew> estimateFareNew(@FieldMap Map<String, Object> params);
